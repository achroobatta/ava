...
param stoprefix string
param locationAbbrv string
...
var privateEndpointNameForStorage = 'pve-${location}-${stoprefix}-${locationAbbrv}-${serviceAbbrv}-${component}-00${instance}'
    ...
    privateDnsZoneConfigs: [
      {
        name: 'storage-config'
        properties: {
          privateDnsZoneId: resourceId(connSubId, connRg, 'Microsoft.Network/privateDnsZones', privateDnsZoneName)
        }
      }
    ]
  }
