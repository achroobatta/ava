...
function copyFilefromLocaltoStorage() {
    param ($commRG, $keyVaultNameforSecret, $destStorageAccount, $unzipPath, $destContainerName, $zipPath, $targetDataType, $localTargetDirectory, $subId, $subTenantId, $runType)
