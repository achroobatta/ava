...
#pass=<use the secret stored in kv-np-edc-security-001\discovery-linux>
pass=$1
user=discovery
...
lines=("$user ALL=(root) NOPASSWD: /usr/bin/chage" \
"$user ALL=(root) NOPASSWD: /etc/chpasswd" \
"$user ALL=(root) NOPASSWD: /usr/sbin/dmidecode" \
"$user ALL=(root) NOPASSWD: /sbin/fdisk -l" \
"$user ALL=(root) NOPASSWD: /usr/bin/multipath -ll" \
"$user ALL=(root) NOPASSWD: /sbin/dmsetup table *" \
"$user ALL=(root) NOPASSWD: /sbin/dmsetup ls" \
"$user ALL=(root) NOPASSWD: /sbin/lshw")
