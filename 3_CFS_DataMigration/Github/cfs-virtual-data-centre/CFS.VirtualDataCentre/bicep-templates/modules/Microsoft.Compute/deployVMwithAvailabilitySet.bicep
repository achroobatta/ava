...
@description('Determines the storage type used for the default data disk')
...
@description('The name of target availability set')
...
resource vmName_resource 'Microsoft.Compute/virtualMachines@2021-07-01' = {
  ...
  properties: {
    availabilitySet: {
      id: ((!empty(availabilitySetName)) ? resourceId('Microsoft.Compute/availabilitySets', availabilitySetName) : json('null'))
    }
    hardwareProfile: {
      vmSize: vmSize
    }
