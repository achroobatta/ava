...
resources = yaml(content: inspec.profile.file("generic_resources.yml")).params
control "generic_resources" do
  impact 0.6
  title "Azure: Confirm standard deployment of XXX"
  desc "Azure: Confirm standard deployment of XXX"
  tag "azure", "resources"
  if !resources.blank?
